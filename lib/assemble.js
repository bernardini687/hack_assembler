...
/**
 * Perform assembly of a source `.asm` file into a binary `.hack` file.
 *
 * @param {string} filesource The path of the source `.asm` file
 * @param {string} filedest The path of the destination `.hack` file
 */
